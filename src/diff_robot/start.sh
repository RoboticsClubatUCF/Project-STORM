...
source /workspaces/Project-STORM/install/setup.bash
...
ros2 run nav2_map_server map_server --ros-args -p yaml_filename:=/workspaces/Project-STORM/src/diff_robot/map/my_map.yaml &
...
python3 /workspaces/Project-STORM/src/diff_robot/planning/a_star_path_finding.py &
echo "A* PATH PLANNER"

# sleep 4

# python3 /workspaces/Project-STORM/src/diff_robot/control/visualize.py
