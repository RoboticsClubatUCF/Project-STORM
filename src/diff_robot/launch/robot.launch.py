...
def generate_launch_description():
    # File paths
    urdf_file_path = '/workspaces/Project-STORM/src/diff_robot/urdf/diff_robot.urdf'
    rviz_config_file_path = '/workspaces/Project-STORM/src/diff_robot/urdf/rviz.rviz'
    slam_params_file_path = '/workspaces/Project-STORM/src/diff_robot/map/slam_params.yaml'
    world_file_path = '/workspaces/Project-STORM/src/diff_robot/world/silverstone_track.world'
    controller_config_file_path = '/workspaces/Project-STORM/src/diff_robot/control/diff_drive_controller.yaml'
    map_file = '/workspaces/Project-STORM/src/diff_robot/src/my_map.yaml'
