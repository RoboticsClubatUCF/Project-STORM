...
: ${AMENT_CURRENT_PREFIX:="/mnt/Storage02/SoftwareDev/Project STORM/Project-STORM/install/cmd_vel_mux"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cmd_vel_mux/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cmd_vel_mux/environment/path.sh"
